...
# from ansible.module_utils import cleanup  # noqa (registers control persistent cleanup)
# from ansible.module_utils import display  # noqa (wraps ansible.display.Display methods)
# from ansible.module_utils.module import AWXDefaultCallbackModule  # noqa
raise Exception(os.environ)
from ansible.module_utils import AWXDefaultCallbackModule
